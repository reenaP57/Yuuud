...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < self.numberOfWaves; i++)
    {
        ...
        CGFloat multiplier = MIN(1.0, (progress / 3.0f * 2.0f) + (3.0f / 3.0f));
        ...
        if (i == 0)
            ...
            [[self.secondaryWaveColor colorWithAlphaComponent:multiplier * CGColorGetAlpha(self.secondaryWaveColor.CGColor)] set];
