...
static NSString *const LOADINGKEY = @"LoaderLoadingKey";
...
{
    [self showLoaderWithType:loaderType withText:MILocalizedString(LOADINGKEY, @"Loading...")];
}
...
-(void)ShowHudLoader
{
        [self ShowHudLoaderWithText:MILocalizedString(LOADINGKEY, @"Loading...")];
}
